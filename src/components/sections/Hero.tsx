...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-svh items-center overflow-hidden">
      ...
      {/* oversized watermark — the board's subject, spelled out, kept just barely legible */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 hidden items-center justify-end overflow-hidden lg:flex"
      >
        <span className="mr-[-2vw] select-none whitespace-nowrap font-mono text-[18vw] font-bold leading-none text-white/[0.035]">
          AVİYONİK
        </span>
      </div>
      ...
      <div className="relative mx-auto w-full max-w-content px-6 md:px-8">
        <div className="flex items-end justify-between gap-12">
          ...
          <motion.div {...enter(0.5)} className="pb-1">
            <HeroHud />
          </motion.div>
        </div>
      </div>
